    ...
    function CatalogDrawer(props) {
      ...
      return h("div", {
        ...
        h("div", {
          ...
          h(UpdateBanner, {
            ...
            onUpdate: function () {
              ...
              runUpdate("self", function (err, data) {
                ...
                if (data && data.ok) {
                  setUpdateNote({ ok: true, text: data.message || "已打开更新窗口，完成后请重启 DSH" });
          ...
          h("div", { "data-dsh-plugins-grid": "" }, cards),
          (!loading && !error && matched.length === 0) ? h("div", { style: { color: MUTED } }, "没有匹配的插件") : null,
          (!loading && !error && matched.length > 0) ? h("div", { style: { marginTop: 14 } },
